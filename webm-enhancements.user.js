...
// To change these settings, visit https://twibooru.org/settings/edit?active_tab=userscript
/* =============================================================== */

    NodeCreationObserver.init('webm-enhancements-observer');
    const SCRIPT_ID = 'webm_enhancements';
    const CSS = `/* Generated by Twibooru WebM Enhancements */
.video-container {
    position: relative;
}
            ...
            .then((obj) => {
                ...
                if ((isMainImage && !document.hidden) || video.paused && !document.hidden) {
                    video.play().catch(function () {
                        ...
                        console.log('Twibooru WebM Volume Toggle: Unable to play video unmuted, playing it muted instead.');
                        toggleVolume(video);
                        video.play();
                    });
                }
