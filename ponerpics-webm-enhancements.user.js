// ==UserScript==
// @name         Ponerpics WebM Enhancements
...
/* =============================================================== */
    ...
    const CSS = `/* Generated by Ponybooru WebM Enhancements */
.video-container {
    position: relative;
}
            ...
            .then((obj) => {
                ...
                if ((isMainImage && !document.hidden) || video.paused && !document.hidden) {
                    video.play().catch(function () {
                        ...
                        console.log('Ponybooru WebM Enhancements: Unable to play video unmuted, playing it muted instead.');
                        toggleVolume(video);
                        video.play();
                    });
                }
