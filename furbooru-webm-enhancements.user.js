// ==UserScript==
// @name         Furbooru WebM Enhancements
// @description  Better webm experience
// @version      1.4.2
// @author       Marker
// @license      MIT
...
/* =============================================================== */
    ...
    const CSS = `/* Generated by Furbooru WebM Enhancements */
.video-container {
    position: relative;
}
            ...
            .then((obj) => {
                ...
                if ((isMainImage && !document.hidden) || video.paused && !document.hidden) {
                    video.play().catch(function () {
                        ...
                        console.log('Furbooru WebM Enhancements: Unable to play video unmuted, playing it muted instead.');
                        toggleVolume(video);
                        video.play();
                    });
                }
